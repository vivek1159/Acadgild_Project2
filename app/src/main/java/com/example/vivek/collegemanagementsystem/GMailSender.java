...
public class GMailSender extends javax.mail.Authenticator {
    ...
    public GMailSender() {
        ...
        Log.d("GMailSender: ", "Inside Constructor");
        this.user = "rsaic2000@gmail.com";
        this.password = "x3TRy66pxr3XjwZmEkWWzg==";

        Log.d("GMailSender: ", "setting properties");
        ...
        Log.d("GMailSender: ", "Setting session");
        session = Session.getInstance(props, new GMailAuthenticator(this.user, this.password));

        Log.d("GMailSender: ", "Multipart something");
        _multipart = new MimeMultipart();
        Log.d("GMailSender: ", "Multipart "  + _multipart);
    }
    ...
    public synchronized Boolean sendMail(String subject, String body, String sender, String recipients) throws Exception {
        ...
        if (_multipart.getCount() > 0) {
            Log.d("GMailSender: ", "Inside Multipart IF");
        ...
        Thread sendmail = new Thread() {
            ...
            public void run() {
                try {
                    Log.d("GMailSender: ", "Transporting...");
        ...
        Log.d("GMailSender: ", "Starting thread...");
        ...
        } else if (TextUtils.isEmpty(recipients)) {
...
class GMailAuthenticator extends Authenticator {
    ...
    public GMailAuthenticator(String username, String password) {
        super();
        this.user = username;
        this.pw = Utils.decryptIt(password);
    }
